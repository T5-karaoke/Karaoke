...
public class SearchReqDto {
    @ApiModelProperty(value = "검색어", required = false, example = "소주 한잔")
    private String searchValue;

    @ApiModelProperty(value = "카테고리", required = false, example = "발라드")
    ...
    @ApiModelProperty(value = "페이지당 노래 개수", required = false, example = "20")
    private int count;
