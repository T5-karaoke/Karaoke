window.onload = () => {
    ...
    ComponentComposerEvent.getInstance().getComposerSearchEvent();
...
class ComponentComposerEvent {
    ...
    getComposerSearchEvent() {
        const responseData = SongSearchApi.getInstance().getComposerList(searchObj);
